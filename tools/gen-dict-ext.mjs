...
const WORD_BLOCK = new Set([
  ...
  // 武侠江湖
  '内力', '招数', '掌门', '招式', '门派', '侠客', '决斗', '秘籍', '掌门人', '走江湖', '闯荡江湖', '令狐掌门', '江湖', '叹息', '寂寞', '背影', '孤独', '流浪', '孤单', '离别', '惆怅', '漂泊', '孤寂', '荒凉', '阴沉', '萧条', '昏暗', '阴暗', '低迷', '衰败', '消沉', '痛苦', '煎熬', '折磨', '呻吟', '呜咽', '痛哭', '泪流满面', '悲伤', '哭泣', '百度', '奔驰', '网易', '可口可乐', '古代', '明朝', '清朝', '元朝', '唐朝', '宋朝', '隋朝', '汉朝', '宇宙', '天体', '星系', '行星', '光年', '银河', '陨石', '彗星', '太阳系', '银河系', '小行星', '星系团', '宇宙线', '人造卫星', '宇宙飞船', '宇宙空间', '分数', '系数', '整数', '基数', '乘法', '分数线', '疫苗', '处方', '包扎', '放疗', '药方', '接种', '绷带', '药剂', '合同', '谈判', '条款', '合约', '合同法', '手铐', '危机', '危险', '危难', '绝境', '逆境', '危险性', '经济危机', '叹息', '寂寞', '背影', '孤独', '流浪', '孤单', '离别', '惆怅', '漂泊', '孤寂', '荒凉', '阴沉', '萧条', '昏暗', '阴暗', '低迷', '衰败', '消沉', '痛苦', '煎熬', '折磨', '呻吟', '呜咽', '痛哭', '泪流满面', '悲伤', '哭泣', '冲突', '对立', '敌对', '对抗', '抗衡', '较量', '纷争', '纠纷', '对立面', '争执', '危机', '危险', '危难', '绝境', '逆境', '危险性', '经济危机',
  // 粗口侮辱
