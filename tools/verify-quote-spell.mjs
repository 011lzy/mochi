...
const placeWords = ['中国', '北京', '上海', '天安门', '人民政府', '国务院', '鄂州', '鄂州市', '广东', '深圳', '解放军', '共产党',
  ...
  '军队', '战争', '武器', '警察', '犯罪', '监狱', '股票', '贷款', '上帝', '魔鬼', '皇帝', '宰相', '僵尸', '癌症', '赌博', '贪污', '政府', '导弹', '服务器', '手枪', '爆炸', '骗子', '俘虏', '虐待', '暴力', '神仙', '甲方', '签约', '牢房', '知府', '江湖', '掌门', '畜生', '混蛋', '婊子', '贱人', '算卦', '地震', '火山', '手术', '化疗', '崩溃', '绝望', '背叛', '上床', '避孕', '流产', '打针', '输液', '住院', '怀孕', '浴室', '同居', '左派', '右派', '卫队', '乳房', '性爱', '精子', '卵子', '太监', '尚书', '央行', '激素', '耳光', '打架', '斗殴', '肝病', '体罚', '内伤', '报社', '地质', '联赛', '裁判', '档案', '公文', '博弈', '参议员', '公务员', '病理', '诊断', '炎症', '悲惨', '悲痛', '沮丧', '狮子', '鲨鱼', '鳄鱼', '蝎子', '俘虏', '虐待', '暴力', '神仙', '甲方', '签约', '牢房', '知府', '马克思主义', '民主集中制', '毛主席纪念堂', '万平方公里', '发展中国家', '本行政区域', '自然保护区', '人民日报', '国家主席', '纪念堂', '阶级', '宪法', '司令', '安定团结', '国共合作', '商品经济'];
